...
export const heroSlides = [
  {
    ...
    body: "نقدم تجربة واضحة من إصدار التأشيرة واختيار السيرة الذاتية حتى توقيع العقد ووصول العمالة."
  },
  {
    image: "/office-slide-2.jpeg",
    eyebrow: "إجراءات منظمة ومتابعة مستمرة",
    title: "منصة احترافية لخدمات الاستقدام ونقل الخدمات",
    body: "فريق متخصص يتابع طلبك خطوة بخطوة ويمنحك خيارات مناسبة وقرارات أكثر اطمئنانا."
  },
  {
    image: "/office-slide-3.jpeg",
    eyebrow: "خدمة سعودية بطابع فاخر",
    title: "استقدام، نقل خدمات، وتأجير شهري في مكان واحد",
    body: "اختر الخدمة الآن وسنرسل طلبك مباشرة عبر واتساب برسالة مرتبة وواضحة."
  }
];

export const stats = [
  { value: "8+", label: "أعوام خبرة" },
  { value: "6", label: "دول استقدام" },
  { value: "24/7", label: "دعم ومتابعة" },
  { value: "3", label: "أشهر ضمان" }
];
...
export const recruitmentSteps = [
  ...
  {
    title: "توقيع العقد",
    body: "بعد اعتماد الاختيار، يتم توثيق الاتفاق وتوضيح الالتزامات والمدة المتوقعة."
  },
  {
    title: "وصول العمالة",
...
export const recruitmentRequirements = [
  {
    ...
    items: ["التأشيرة الأصل", "صورة الهوية أو الإقامة", "تعريف بالراتب", "كشف حساب بنكي", "توقيع عقد الاستقدام"]
  },
  {
    icon: ClipboardCheck,
    title: "إجراءات الاستقدام",
    items: ["إصدار التأشيرة", "اختيار السيرة الذاتية", "توقيع العقد", "بدء الإجراءات", "وصول العمالة"]
  }
];
...
export const faqs = [
  ...
  {
    question: "ماهي الأوراق المطلوبة للاستقدام؟",
    answer: "1- التأشيرة\n\n2- بطاقة الأحوال\n\n3- الرقم المربوط بابشر\n\n4- اختيار السيفي المناسب لربط العقد."
  },
  {
    question: "ماهي أسباب رفض إصدار التأشيرة؟",
    answer: "1- المخالفات\n\n2- تجاوز الحد في العدد المسموح به\n\n3- إيقاف الخدمات\n\n4- عدم سداد الرسوم"
  },
  {
  ...
  },
  {
    ...
    answer: "تقدم شركة المنصة الذهبية للاستقدام خدمة تسليم العاملة في جميع انحاء المملكة او زيارة المكتب المحلي."
  },
  {
